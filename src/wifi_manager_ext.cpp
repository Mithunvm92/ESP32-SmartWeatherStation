...
bool WiFiManagerExt::begin() {
    ...
    // Try hardcoded WiFi credentials first
    ...
    // Hardcoded WiFi failed - start WiFiManager portal
    Serial.println("");
    ...
    // Use autoConnect - will open portal if no saved credentials
